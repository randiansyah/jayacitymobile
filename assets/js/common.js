...
require.config({
    paths: {
        ...
        "jQuery_v213": "../../plugins/jquery/2.1.3/jquery",
        ...
        "bootstrapDaterangepicker" : "../../plugins/daterangepicker/daterangepicker",
        "bootstrapDatepicker" : "../../plugins/bootstrap-datepicker/bootstrap-datepicker",
        ...
        "bootstrapTimepicker" : "../../plugins/bootstrap-timepicker/bootstrap-timepicker.min",
   ...
   //urlArgs: "bust=" + (new Date()).getTime(),    
    shim: {
        ...
        "jQuery_v213": {
            exports: "jQuery_v213",
            init: function(){
                console.log('jQuery_v213 inited..');
            }
        },        
        "bootstrap": {
            deps: ["jQuery"],
