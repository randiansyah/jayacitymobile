...
class Tunggakan_brand_detail_model extends CI_Model
{
    ...
    function getAllBy($limit, $start, $search, $col, $dir, $where, $setting_hari)
    {
        ...
        $this->db->JOIN('transaksi as s','s.id_pelanggan=angsuran.id_pelanggan');
        $this->db->join('brand as b','b.id=s.merek');
