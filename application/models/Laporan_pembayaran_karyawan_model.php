...
class Laporan_pembayaran_karyawan_model extends CI_Model
{
    ...
    function getAllBy($limit, $start, $search, $col, $dir, $day)
    {
        ...
        $this->db->select("karyawan.*,COUNT(a.id_angsuran) as jumlah")->from("karyawan");
        $this->db->join('angsuran as a', 'a.teller=karyawan.id');
