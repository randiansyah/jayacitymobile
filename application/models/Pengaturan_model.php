...
class Pengaturan_model extends CI_Model
{
    ...
    public function update_jatuh_tempo($data,$where){
        $this->db->update('pengaturan_jatuh_tempo', $data, $where);
        return $this->db->affected_rows();
    }
    ...
    function getOneByJatuhTempo($where = array()){
        $this->db->select("*");
    ...
    {
        $this->db->select("pengaturan.*")->from("pengaturan"); 
