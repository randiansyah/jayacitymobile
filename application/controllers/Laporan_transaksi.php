...
class Laporan_transaksi extends Admin_Controller
{
  ...
  public function dataList()
  {
    ...
    $datas = $this->transaksi_model->getAllByLaporan($limit, $start, $search, $order, $dir, $where);
    ...
    if (!empty($datas)) {
      foreach ($datas as $key => $data) {
        ...
        $nestedData['jumlah']          = "<a href='" . base_url() . "transaksi'><i class='fa fa-eye'></i> " . $data->jumlah . "</a> ";
