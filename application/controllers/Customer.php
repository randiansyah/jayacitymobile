...
class Customer extends Admin_Controller
{
  ...
  public function dataList()
  {
    ...
    $datas = $this->customer_model->getAllBy($limit, $start, $search, $order, $dir, $where);
    ...
    if (!empty($datas)) {
      foreach ($datas as $key => $data) {
        ...
        } else if ($data->status_pembayaran == 2) {
          $star = "<i class='fa fa-star'></i><i class='fa fa-star'>";
        ...
        $nestedData['status_pembayaran']    = $star;
  ...
  public function edit($id)
  {
    ...
    if ($this->form_validation->run() === TRUE) {
      ...
      $this->data['status_pembayaran'] =   (!empty($data)) ? $data[0]->status_pembayaran : "";

      //data pemohon
      $dataP = $this->customer_model->getAllByIdPemohon(array("id_pelanggan" => (!empty($data)) ? $data[0]->id_pelanggan : ""));
      $this->data['pekerjaan'] =   (!empty($dataP)) ? $dataP[0]->pekerjaan : "";
      $this->data['jabatan'] =   (!empty($dataP)) ? $dataP[0]->jabatan : "";
      $this->data['lama_kerja'] =   (!empty($dataP)) ? $dataP[0]->lama_kerja : "";
      $this->data['nama_instansi'] =   (!empty($dataP)) ? $dataP[0]->nama_instansi : "";
      $this->data['alamat_instansi'] =   (!empty($dataP)) ? $dataP[0]->alamat_instansi : "";
      $this->data['nama_usaha'] =   (!empty($dataP)) ? $dataP[0]->nama_usaha : "";
      $this->data['alamat_usaha'] =   (!empty($dataP)) ? $dataP[0]->alamat_usaha : "";
      $this->data['penghasilan_usaha'] = (!empty($dataP)) ? $dataP[0]->penghasilan_usaha : "";
      $this->data['pengeluaran_rutin'] = (!empty($dataP)) ? $dataP[0]->pengeluaran_rutin : "";
      $this->data['pengeluaran_kredit'] = (!empty($dataP)) ? $dataP[0]->pengeluaran_kredit : "";
      $this->data['penghasilan_pokok'] = (!empty($dataP)) ? $dataP[0]->penghasilan_pokok : "";
      $this->data['tunjangan_penghasilan'] = (!empty($dataP)) ? $dataP[0]->tunjangan_penghasilan : "";
