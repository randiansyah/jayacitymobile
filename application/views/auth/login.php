...
<head>
  ...
  <title>JAYA CITY MOBILE | Log in</title>
...
<div class="login-box">
  <div class="login-logo" style="margin-top: -34px;">
    <img src="<?php echo base_url()?>assets/images/smart-logo-render.png" width="180"><br>
    <a href="<?php echo base_url()?>"><b style="font-weight: 600;">JAYA CITY MOBILE</b></a>
  </div>
  <!-- /.login-logo -->
...
<!-- /.login-box -->
<center>
<p style="color:white">&copy; Copyright <?php echo date('Y');?> <b>Jaya City Mobile</b> - Powered By <a href="#" target="_blank" style="color: white">Mangga Dingin</a> <br> Full Version</p>
</center>
