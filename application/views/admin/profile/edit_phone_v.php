              ...
              <form class="form-horizontal" id="form" method="POST" action="">
                <div class="box-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                     <input type="number" class="form-control" id="" placeholder="phone" name="phone" value="<?php echo $phone;?>">
                    </div>
                  </div> 
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-right">
                      ...
                      <button type="submit" class="btn btn-sm btn-info" name="profil_pengguna" value="1" id="save-btn">Ubah</button>
                    </div>
                </div>
              </form>
            </div>
