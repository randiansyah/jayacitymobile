...
<section class="content">
  <div class="box box-default color-palette-box">
    <div class="box-header with-border">
      <h3 class="box-title"><i class="fa fa-tag"></i> Ubah Transaksi</h3>
    </div>
            ...
            <div class="form-group">
              <div class="form-group row">
                <div class="col-md-8"> <label for="">INV PELANGGAN</label>
                  <input class="form-control" id="id_invoice" name="id_invoice" autocomplete="off" value="<?php echo $data->id_invoice ?>" disabled>
              ...
              <div class="form-group">
                <label for="">TGL JATUH TEMPO / BLN</label>
        ...
        <div class="box-footer">
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-right">
              ...
              <button type="submit" id="konfirmasi" class="btn btn-primary pull-right">Ubah</button>
