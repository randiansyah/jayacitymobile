                  ...
                  <div class="box-body">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="sub_judul" name="sub_judul" value="<?php echo "....../......" . date('d-m-Y') . "/Tarakan"; ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="nama_pp" name="nama_pp" value="Irawan" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Alamat</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="alamat_pp" name="alamat_pp" value="Jl. Hang Tuah RT.08 No.23 Kel.Selumit Tarakan 77133" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="jabatan_pp" name="jabatan_pp" value="Direktur" required>
                        </div>
                      </div>
                      <hr>---</hr>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Nama</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control nama_pk" id="nama_pk" name="nama_pk" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Tempat Tgl Lahir</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="tempat_tgl_lahir_pk" name="tempat_tgl_lahir_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Nik</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="nik_pk" name="nik_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Pekerjaan</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="pekerjaan_pk" name="pekerjaan_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Alamat KTP</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="alamat_ktp_pk" name="alamat_ktp_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Alamat Sekarang</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="alamat_sekarang_pk" name="alamat_sekarang_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">HP</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="hp_pk" name="hp_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="nama_barang_pk" name="nama_barang_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">S/N</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="sn_pk" name="sn_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Imei 1</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="imei1_pk" name="imei1_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Imei 2</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="imei2_pk" name="imei2_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control harga" id="harga_pokok_pk" name="harga_pokok_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Keuntungan Pihak Pertama/Penjual</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control harga" id="keuntungan_pp" name="keuntungan_pp" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Harga Jual</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control harga" id="harga_jual_pk" name="harga_jual_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Biaya Admin</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control harga" id="biaya_admin_pk" name="biaya_admin_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Asuransi Jiwa</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control harga" id="asuransi_jiwa_pk" name="asuransi_jiwa_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Uang Muka</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control harga" id="uang_muka_pk" name="uang_muka_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Terhutang Pihak Kedua</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control harga" id="harga_pokok_pk1" name="harga_pokok_pk1" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control besaran_terbilang" id="besaran_terbilang" name="besaran_terbilang" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                          <input type="number" class="form-control cicilan" id="cicilan" name="cicilan" value="" required>
                        </div>
                        ...
                        <div class="col-sm-3">
                          <input type="number" class="form-control " id="cicilan1" name="cicilan1" value="" required>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                          <input type="number" class="form-control " id="cicilan2" name="cicilan2" value="" required>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="number" class="form-control" id="cicilan3" name="cicilan3" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Besaran Cicilan Perbulan</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control harga" id="besaran_cicilan_pk" name="besaran_cicilan_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-6 control-label">3. Jatuh Tempo cicilan setiap bulannya adalah tanggal </label>
                        <div class="col-sm-4">
                          <input type="number" class="form-control" id="cicilan4" name="cicilan4" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-6 control-label">4. Jatuh Tempo cicilan pertama </label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="jatuh_tempo_pertama_pk" name="jatuh_tempo_pertama_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-6 control-label">5. Jatuh Tempo cicilan Terkahir </label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="jatuh_tempo_terakhir_pk" name="jatuh_tempo_terakhir_pk" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Besaran Terbilang</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control " id="besaran_terbilang2" name="besaran_terbilang2" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="text" class="form-control" id="nama_pk1" name="nama_pk1" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Pihak Pertama</label>
                        <div class="col-sm-5">
                          <input type="text" class="form-control" id="nama_pp1" name="nama_pp1" value="Irawan" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Saksi 1</label>
                        <div class="col-sm-5">
                          <input type="text" class="form-control" id="saksi1" name="saksi1" value="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 control-label">Saksi 2</label>
                        <div class="col-sm-5">
                          <input type="text" class="form-control" id="saksi2" name="saksi2" value="" required>
                        </div>
                      </div>
