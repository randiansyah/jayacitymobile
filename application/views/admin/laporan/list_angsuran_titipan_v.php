    ...
    <div class="box-header with-border">
      <h3 class="box-title"> <?php echo $title;?></h3>
       <div class="datatableButton pull-right">
            <a href="<?php echo base_url('Laporan_dana_titipan/angsuran_pdf') ?>" target="blank" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf-o"></i> Export PDF</a>
             ...
             //   $totalnya = 0;
                ...
                { ?>
                  ...
                  <td><?php echo $i; ?></td>
                    ...
                    <td><a href="<?php echo base_url('laporan_dana_titipan/detail/').$value["date"]?>" ><i class="fa fa-search"></i> Rp.<?php echo number_format($value["sub_total"], 0, ".", ".")?></a></td>
