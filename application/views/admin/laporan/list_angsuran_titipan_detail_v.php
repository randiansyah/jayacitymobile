      ...
      <h3 class="box-title"> <?php echo $title;?></h3>
       <div class="datatableButton pull-right">
         <?php
           ...
           ?>
       <a href="<?php echo base_url('Laporan_dana_titipan/angsuran_detail_pdf/').$getDate ?>" target="blank" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf-o"></i> Export PDF</a>
