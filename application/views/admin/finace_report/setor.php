<section class="content-header">
    <h1>
        <?php echo ucwords(str_replace("_", " ", $this->uri->segment(1). " - " . $this->uri->segment(2))) ?>
        <small></small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="box box-default color-palette-box">
        <div class="box-header with-border">
            <h3 class="box-title">
            <i class="fa fa-tag"></i> <?php echo ucwords(str_replace("_", " ", $this->uri->segment(1))) ?>
            </h3>
        </div>
        <div class="box-body">
...
<script data-main="<?php echo base_url() ?>assets/js/main/main-report_setor.js" src="<?php echo base_url() ?>assets/js/require.js"></script>
