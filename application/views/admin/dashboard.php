                    ...
                    <section class="col-lg-12 connectedSortable">
                        <div class="nav-tabs-custom">
                            ...
                            <ul class="nav nav-tabs pull-right">
                                <li>
                                    <a href="#dana_titipan" data-toggle="tab">Dana Titipan</a>
                                </li>
                                <li class="active">
                                ...
                                <li class="pull-left header">
                                    ...
                                    Grafik <span style="font-size: 15px;"><?php 
                                          echo  $start_date  = date("d M Y", strtotime(date('Y-m') . '-01'));
                                          echo "  s/d  ";
                                          echo	$end_date = date("d M Y", strtotime(date('Y-m') . '-31'));
                                  ?></span>
                                </li>
                            </ul>
                            <div class="tab-content no-padding">
                                ...
                                <div class="chart tab-pane" id="dana_titipan" style="position: relative; height: 300px;"></div>
                            </div>
                        </div>
                    </section>
                </div>
