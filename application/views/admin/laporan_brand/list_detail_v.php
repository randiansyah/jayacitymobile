<section class="content-header">
    <h1>
     Tunggakan dengan merek
        <?php echo $name_brand[0]->name; ?>
        <small></small>
    </h1>
    <ol class="breadcrumb">
...
<script data-main="<?php echo base_url() ?>assets/js/main/main-tunggakan-brand-detail.js" src="<?php echo base_url() ?>assets/js/require.js">
</script>