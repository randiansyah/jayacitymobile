...
<head>
  ...
  <title><?php echo ucwords(str_replace("_"," ",$this->uri->segment(1)))?> - JAYA CITY MOBILE</title>
...
-->
  <link rel="stylesheet" href="<?php echo base_url();?>assets/plugins/select2/select2.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/plugins/bootstrap-timepicker/bootstrap-timepicker.min.css">
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/css/admin.min.css"> 
   ...
   <link rel="stylesheet" href="<?php echo base_url();?>assets/plugins/button/css/buttons.bootstrap.min.css">
