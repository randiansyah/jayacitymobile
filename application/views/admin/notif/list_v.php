  ...
  <div class="box box-default color-palette-box">
    ...
    <div class="col-sm-1 datatableButton pull-right">
      <div class="row">
        ...
        <a href="<?php echo base_url()?>notif/create" class="btn btn-sm btn-primary"><i class='fa fa-plus'></i> <?php echo ucwords(str_replace("_"," ",$this->uri->segment(1)))?></a>
        <?php 
      }
      ?>
      </div>
...
<script 
  data-main="<?php echo base_url()?>assets/js/main/main-notif.js" 
